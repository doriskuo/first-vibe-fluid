...
function FullscreenFluid() {
  ...
  useFrame(({ clock }) => {
    ...
    if (['cyberpunkEntry', 'descent', 'theaterSpace', 'audioSim', 'visualSim', 'portal', 'returnToCenter', 'centerLock', 'featureShowcase', 'holographicProjection', 'finalLanding'].includes(currentStageName)) {
