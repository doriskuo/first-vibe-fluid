            ...
            <AnimatePresence>
                {showPrompt && (
                    ...
                    >
                        ...
                        >
                            <span className="text-white/40 text-[10px] sm:text-xs tracking-[0.2em] sm:tracking-[0.3em] uppercase font-mono">
                                SCROLL TO CONTINUE
                            </span>
                            <motion.div
                                animate={{ y: [0, 8, 0] }}
            ...
            <AnimatePresence>
                {showCard && (
                    <motion.div
                        ...
                        className="fixed inset-0 z-[90] flex items-end pb-16 sm:pb-24 justify-start pl-4 sm:pl-12 md:pl-24 pointer-events-none"
                    >
                        {/* Glassmorphism Card */}
                        <motion.div
                            ...
                            className="relative w-[calc(100%-2rem)] sm:w-auto sm:max-w-md pointer-events-auto"
                        >
                            ...
                            <div className="relative overflow-hidden rounded-lg p-4 sm:p-6 shadow-2xl shadow-[#00f3ff]/10"
                                style={{
                            ...
                            >
                                ...
                                {/* Header */}
                                <div className="mb-6">
                                    <span className="text-[#00f3ff] text-[10px] sm:text-xs font-mono tracking-[0.2em] sm:tracking-[0.3em] uppercase opacity-60">
                                        FLUID_DYNAMIC
                                    </span>
                                    <h2 className="text-white text-2xl sm:text-3xl md:text-4xl font-light tracking-wide mt-1 sm:mt-2">
                                        VR Headset
                                    </h2>
                                    <p className="text-white/40 text-xs sm:text-sm mt-1 font-light tracking-wider">
                                ...
                                <motion.button
                                    ...
                                    className="relative w-full py-2.5 sm:py-3 px-4 sm:px-6 rounded overflow-hidden group"
                                >
